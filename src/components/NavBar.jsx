...
const NavBar = () => {
    return (
        <nav className="mb-20 flex justify-between items-center py-6">
            ...
            <a href="https://github.com/omomo17" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    <FaGithub className="hover:text-gray-600 transition-colors duration-200" />
                </a>
                <a href="https://www.instagram.com/omomo_aa" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
