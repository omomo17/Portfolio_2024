...
export const ABOUT_TEXT = `I am an project engineer with a passion for developing inspection devices centered around image processing. Leveraging my experience in 3D modeling, electrical control, and machine learning, I build precise and efficient systems. My primary development work is done using C# and Python, and I continuously seek to acquire new knowledge to solve technical challenges.`;
